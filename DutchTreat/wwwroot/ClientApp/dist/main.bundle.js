...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["M" /* NgModule */])({
        declarations: [
            __WEBPACK_IMPORTED_MODULE_3__app_component__["a" /* AppComponent */], __WEBPACK_IMPORTED_MODULE_4__shop_productList_component__["a" /* ProductList */], __WEBPACK_IMPORTED_MODULE_5__shop_cart_component__["a" /* Cart */], __WEBPACK_IMPORTED_MODULE_6__shop_shop_component__["a" /* Shop */], __WEBPACK_IMPORTED_MODULE_7__checkout_checkout_component__["a" /* Checkout */], __WEBPACK_IMPORTED_MODULE_8__login_login_component__["a" /* Login */] //, MyErrorStateMatcher
        ],
        imports: [
...
var Checkout = (function () {
    ...
    Checkout.prototype.onItemDelete = function (item) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__orderItem__ = __webpack_require__("../../../../../ClientApp/app/shared/orderItem.ts");
...
var DataService = (function () {
    ...
    DataService.prototype.DeleteFromOrder = function (item) {
        __WEBPACK_IMPORTED_MODULE_5_lodash__["pull"](this.order.items, item);
    };
    DataService.prototype.loadProducts = function () {
        var _this = this;
        return this.http.get("/api/products")
            .map(function (r) { return _this.products = r.json(); });
    };
    ...
    DataService.prototype.AddToOrder = function (product) {
        ...
        if (item) {
            ...
            item = new __WEBPACK_IMPORTED_MODULE_4__orderItem__["a" /* OrderItem */]();
    ...
    DataService.prototype.IsCheckedOut = function (product) {
        var item = this.order.items.find(function (i) { return i.productId == product.id; });
        if (item) {
            if (item.quantity > 0)
                return true;
    ...
    DataService.prototype.DecrementQuantity = function (product) {
        var item = this.order.items.find(function (i) { return i.productId == product.id; });
        if (item) {
            if (item.quantity > 1)
                item.quantity--;
...
module.exports = "<h3>Shopping Cart 4/24</h3>\r\n<div>xxx/Items: {{ data.order.items.length }}</div>\r\n<div>Shop Checkout Subtotal: {{ data.order.subtotal | currency:\"USD\":true  }}</div>\r\n<table class=\"table table-condensed table-hover\">\r\n    <thead>\r\n        <tr *ngIf=\"data.order.items.length > 0\">\r\n            <td>Product</td>\r\n            <td>##</td>\r\n            <td>Unit</td>\r\n            <td>Total</td>\r\n        </tr>\r\n    </thead>\r\n  <tbody>\r\n      <tr *ngFor=\"let o of data.order.items\">\r\n          <td>{{ o.productCategory }} - {{ o.productTitle }}</td>\r\n          <td>{{ o.quantity }}</td>\r\n          <td>{{ o.unitPrice | currency:\"USD\":true }}</td>\r\n          <td>{{ (o.unitPrice * o.quantity) | currency:\"USD\":true }}</td>\r\n      </tr>\r\n  </tbody>\r\n</table>\r\n<button class=\"btn btn-success\" *ngIf=\"data.order.items.length > 0\" (click)=\"onCheckout()\">Check out</button>"
...
var Cart = (function () {
    ...
    Cart.prototype.onItemEdit = function () {
        if (this.data.loginRequired) {
            // Force Login
            this.router.navigate(["login"]);
        }
...
var ProductList = (function () {
    ...
    ProductList.prototype.DecrementProduct = function (product) {
        this.data.DecrementQuantity(product);
    };
    ProductList.prototype.IsCheckedOut = function (product) {
